...
public class Showtkt extends JFrame {
    ...
    public void initComponents()
    {
        ...
        capLabel = new JLabel();
         ...
         nameLabel.setText("Fariha Zafar Niha");
